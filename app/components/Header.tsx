          ...
          <nav className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => (
              ...
              >
                <Link 
                  href={item.href}
                  className="px-4 py-2.5 text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors duration-300 relative group flex items-center"
                >
                  <motion.span
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white shadow-lg">
            {navItems.map((item) => (
              <Link 
                ...
                className="block px-4 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600 rounded-lg transition-colors duration-200"
              >
                {item.name}
              </Link>
            ))}
            <div className="pt-2 border-t border-gray-100">
              <button 
                ...
                className="w-full px-4 py-2.5 text-center text-base font-medium text-white bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg hover:shadow-md transition-all duration-200"
              >
                Contact Us
              </button>
            </div>
